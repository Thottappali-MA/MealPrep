...
export const MOCK_RECIPES: Recipe[] = [
  {
    ...
    image: 'https://loremflickr.com/800/600/chicken,dinner?lock=1',
    prepTime: 10,
    cookTime: 20,
    servings: 2,
    difficulty: 'Easy',
  ...
  },
  {
    ...
    image: 'https://loremflickr.com/800/600/vegetable,stirfry?lock=1',
    prepTime: 15,
    cookTime: 10,
    servings: 2,
    difficulty: 'Easy',
  ...
  },
  {
    ...
    image: 'https://loremflickr.com/800/600/spaghetti,bolognese?lock=1',
    prepTime: 15,
    cookTime: 45,
    servings: 4,
    difficulty: 'Medium',
